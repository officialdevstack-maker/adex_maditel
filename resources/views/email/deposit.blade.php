 <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
     <div style="margin:50px auto;width:70%;padding:20px 0">
         <div style="border-bottom:1px solid #eee">
             <a href=""
                 style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600"><span>{{ $app_name }}
                 </span></a>
         </div>
         <p style="font-size:1.1em"> <span>Account {{ $deposit_type }}ED</span></p>
         <p>Your account has been {{ strtolower($deposit_type) }}ed ₦{{ $amount }} by Admin</p>
         <style>
             .table {
